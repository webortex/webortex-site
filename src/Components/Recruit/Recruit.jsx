                ...
                <div className="relative max-w-4xl w-full ">
                  <div className="text-center md:mb-24 -z-10">
                    ...
                    <div className="absolute top-[21.5%] xs:top-[26%] sm:top-[31%] md:top-[50%] lg:top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/3 -z-0">
                      <div className="">
                        <img
                          src={recruitData.chairImgMobile}
                          alt="chair-for-recruting"
                          className="block md:hidden scale-[125%] xs:scale-[115%] sm:scale-[110%]"
                        />
                        <img
                          src={recruitData.chairImg}
                          alt="chair-for-recruting"
                          className="hidden md:block xs:scale-[85%] lg:scale-[80%]"
                        />
                      </div>
                    </div>
                  </div>

                  <div className="rounded-3xl border md:border-2 border-[#9C9C9C3B] bg-[#111111] mx-[8%] xs:mx-[10%] sm:mx-[15%] md:mx-0 p-4 md:p-8 flex justify-between -z-10 mt-72 xs:mt-80 sm:mt-96 md:mt-0">
