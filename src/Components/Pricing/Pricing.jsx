...
const Pricing = () => {
  return (
    <Container maxWidth="lg">
      <section id="pricing">
        <h1 className="text-center text-6xl text-white font-bold mt-5">Elevate Your Brand</h1>
        <p className="text-center text-gray-700 mt-2">We offer tailored solutions to help you establish a strong online presence, whether it’s
        stunning website or powerful app </p>
      ...
      <div>
      <h2 className="text-lg font-light mb-4">Contact us today for</h2>
      <h1 className="text-6xl font-bold mb-6">FREE</h1>
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <div>
          <p className="text-sm font-light uppercase">From</p>
          <h3 className="text-3xl font-bold">IDEA</h3>
          <p className="text-sm">to Production</p>
          <p className="text-xs text-gray-400">Have a Vision? We bring it to your Life!</p>
        </div>
      </div>
